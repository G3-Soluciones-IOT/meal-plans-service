package pe.edu.upc.mealplan_service.shared.infrastructure.persistence.jpa.configuration;
...
public class FlywayMigrationConfiguration {
    ...
    private static final String FLYWAY_MIGRATOR_BEAN_NAME = "mealPlansFlywayMigrator";
    ...
    public InitializingBean mealPlansFlywayMigrator(Flyway flyway) {
        return () -> {
    ...
    @Bean
    public static BeanFactoryPostProcessor mealPlansEntityManagerFactoryDependsOnFlyway() {
        return beanFactory -> {
