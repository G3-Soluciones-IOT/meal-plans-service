package pe.edu.upc.mealplan_service.shared.infrastructure.authorization;
...
final class MealPlansJwtAuthenticationConverter {

    private MealPlansJwtAuthenticationConverter() {
    }

    static JwtAuthenticationConverter jwtAuthenticationConverter() {
        var authenticationConverter = new JwtAuthenticationConverter();
        authenticationConverter.setJwtGrantedAuthoritiesConverter(new MealPlansGrantedAuthoritiesConverter());
        return authenticationConverter;
    }

    private static final class MealPlansGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
        @Override
